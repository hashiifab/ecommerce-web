                    ...
                    <div class="row">
                        <div class="col-3 col-lg-12 mt-2 mt-lg-0" v-for="(photo, index) in photos" :key="photo.id" data-aos="zoom-in" data-aos-delay="100">
                            <a href="#" @click.prevent="changeActive(index)">
                                <img :src="photo.url" class="w-100 thumbnail-image" :class="{ active: index == activePhoto }" alt="img" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2" data-aos="zoom-in">
                        <a href="{{ route('cart') }}" class="btn btn-warning px-4 text-white btn-block mb-3">Add To Cart</a>
                    </div>
                </div>
            </div>
        </section>
...
<script>
    var gallery = new Vue({
        ...
        data: {
            activePhoto: 0,
            photos: [
                { id: 1, url: "/images/productdetails1.jpg" },
                { id: 2, url: "/images/productdetails2.jpg" },
                { id: 3, url: "/images/productdetails3.jpg" },
                { id: 4, url: "/images/productdetails4.jpg" },
            ],
        },
        methods: {
            changeActive(index) {
